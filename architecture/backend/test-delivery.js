const { calculateDistance, calculateDeliveryFee, estimateDeliveryTime, calculateDeliveryInfo } = require('./dist/utils/haversine');

console.log('=== 단위 테스트: 배달비 계산 ===\n');

console.log('테스트 1: 근거리 (1km 이내)');
...
console.log('테스트 2: 중거리 (2km 초과 3km 미만)');
...
console.log(`테스트 2: ${result2.isDeliverable && result2.deliveryFee === 3500 ? '✅ PASS' : '❌ FAIL'} (2km초과시 km당 500원 추가)`);
